...
// RoomsReservationsDatabase.getInstance().addReservationByRoom(room101,
// reservation2);
// RoomsReservationsDatabase.getInstance().addReservationByRoom(room101,
// reservation5);
// RoomsReservationsDatabase.getInstance().addReservationByRoom(room101,
...
// RoomsReservationsDatabase.getInstance().addReservationByRoom(room101,
// reservation6);
// RoomsReservationsDatabase.getInstance().get(room101).forEach(item ->
...
// Collection<IRoom> rooms5 =
// RoomsReservationsDatabase.getInstance().findRooms(df.parse("8/12/2022"),
// df.parse("8/16/2022"));
